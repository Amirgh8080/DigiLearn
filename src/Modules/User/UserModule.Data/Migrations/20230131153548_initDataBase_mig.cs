...
{
    /// <inheritdoc />
    public partial class initDataBasemig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolesPerimissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RolesPerimissions_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolesPerimissions_RoleId",
                table: "RolesPerimissions",
                column: "RoleId");
